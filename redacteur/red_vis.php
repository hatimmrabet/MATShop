...
$sql = "SELECT * from t_visuel_vis join t_categorie_cat using (cat_id) order by vis_id desc";
                ...
                <div class="mb-3">
                    ...
                    <select class="custom-select col-4" id="inputGroupSelect01" name="cat" required>
                        <?php
                            ...
                            ?>
                        <option <?php if($premier){echo "selected"; $premier=false;} ?> value="<?php echo $row["cat_id"] ?>"><?php echo $row["cat_intitule"] ?></option>
                            <?php
                                } //Fin boucle while
