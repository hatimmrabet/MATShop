            ...
            <fieldset>
                ...
                <div class="mb-3">
                    ...
                    <select class="custom-select col-3" id="inputGroupSelect01" name="visi" required>
                        <option <?php if($vis["vis_visibilite"]=="C"){ echo "selected"; }?> value="C">Caché</option>
                        <option <?php if($vis["vis_visibilite"]=="L"){ echo "selected"; }?> value="L">En ligne</option>
                    </select>
                </div>
                <div class="mb-3">
                    <label>Selectionnez Catégorie :</label><br>
                    <select class="custom-select col-4" id="inputGroupSelect01" name="cat" required>
                        <?php
                            $requet = "SELECT * from t_categorie_cat";
                            ...
                            ?>
                        <option <?php if($row["cat_id"] == $vis["cat_id"]){ echo "selected"; }?>  value="<?php echo $row["cat_id"] ?>"><?php echo $row["cat_intitule"] ?></option>
                            <?php
                                } //Fin boucle while
